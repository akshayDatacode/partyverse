          ...
          <div className="row mx-0 d-flex justify-content-between align-items-center">
              ...
              <div className="row mx-0">
                <div className="col-md-4 col-12 ps-md-0 pe-md-4 px-4 py-md-4 py-3 footer-section-1">
                  <div className="">
                    ...
                    <p className="my-2 footer-paragraph">Your one-stop solution for stress-free party planning. We handle the details, you create the memories.</p>
            ...
            <div className="col-12 px-md-0 px-4 my-md-0 my-4">
              <div className="row mx-0 d-flex">
                <div className="col-md-4 px-0 footer-paragraph footer-end">© 2025 <span className="partyverse">Partyverse</span> All Rights Reserved.</div>
