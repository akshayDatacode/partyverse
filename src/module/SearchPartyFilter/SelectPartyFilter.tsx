...
const SelectPartyFilter = () => {
  return (
    <div className="row m-0 ">
      <div className="col-3 px-0 text-center select-dropdown py-3 rounded-start ">
        <SelectDropdown label="Location Type" place_holder="Fine Dine"/>
      </div>
      <div className="col-3 px-0 text-center select-dropdown py-3 ">
      ...
      <div className="col-3 px-0 text-center select-dropdown py-3 rounded-end">
