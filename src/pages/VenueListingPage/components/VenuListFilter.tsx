...
const VenuListFilter = () => {
  return (
    <div className="p-2">
      <div className="pb-5">
        <div className="heading pb-2"><Image src={filterIcon} alt="Filter Icon" height={20} width={20} className="me-2 mb-1"/>Top Filters</div>
        <div className="py-1  items">
      ...
      <div>
        <div className="heading pb-3"><Image src={filterIcon} alt="Filter Icon" height={20} width={20} className="me-2 mb-1"/>Other Filters</div>
        <div className="pb-2">
          <div className="sub-heading1 py-2">Budget per Guest</div>
          <div className="py-1 items">
        ...
        <div className="pb-2">
          <div className="sub-heading1 py-2">Restaurant Type</div>
          <div className="py-1 items">
        ...
        <div className="pb-2">
          <div className="sub-heading1 py-2">Cuisine</div>
          <div className="py-1 items">
