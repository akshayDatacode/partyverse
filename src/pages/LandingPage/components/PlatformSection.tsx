...
const PlatformSection = () => {
   return(
    <div className="platform-section row mx-0 pt-0 mt-0 px-md-5 pb-5 mb-5 px-3 ">
        <div className="platform-inner-section col-md-9 col-12 p-md-4 p-3">
            <div className="row mx-0 d-flex align-item-center justify-content-center p-md-4 p-2">
