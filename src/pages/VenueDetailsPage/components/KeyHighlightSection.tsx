...
const KeyHighlightSection = ({ HighlightIconData, videoData }:
    {
                        ...
                        <div className="col-12 p-0">
                            <div className="row mx-0">
                                {HighlightIconData.map((data, index) => {
                                    return (
                                        <div className="col-6 d-flex flex-column align-items-center ps-0 text-start justify-content-center my-2" key={index}>
                                            <div className="highlight-icons p-3 my-2">
                                                <Image src={data.ImageUrl} alt="capacityIcon" />
                                            </div>
                                            <div className="d-flex flex-column align-items-center justify-content-center">
                                                <div className="highlight-icons-data fw-bold">{data.IconData}</div>
                                                <div className="highlight-icons-subdata">{data.IconSubData}</div>
                                            </div>
                                        </div>
                                    )
                                })
